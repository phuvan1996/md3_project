          ...
          <div class="card-header">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
              <div class="container-fluid">
                <a class="navbar-brand" href="<%=request.getContextPath()%>/views/admin/newcatalog.jsp">
            ...
            <table id="example1" class="table table-bordered table-striped text-center">
              ...
              <c:forEach items="${listcatalog}" var="cat">
                <tr>
                  ...
                  <td>${cat.catalogStatus?"Hoat dong":"khong hoat dong"}</td>
                  <td>
                    <a href="<%=request.getContextPath()%>/CatalogServlet?catalogId=${cat.catalogId}&&action=update">
                      <button type="button" class="btn btn-warning">Edit</button>
                    </a>
                    <a href="<%=request.getContextPath()%>/CatalogServlet?catalogId=${cat.catalogId}&&action=delete">
