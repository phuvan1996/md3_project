    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href=<%=request.getContextPath()%>/views/admin/catalog.jsp">
                ...
                <ul class="navbar-nav navbar-align">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                            ...
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="<%=request.getContextPath()%>/views/admin/img/avatars/avatar-2.jpg"
                                                 class="avatar img-fluid rounded-circle"
                                                 alt="William Harris">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="<%=request.getContextPath()%>/views/admin/img/avatars/avatar-4.jpg"
                                                 class="avatar img-fluid rounded-circle"
                                                 alt="Christina Mason">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="<%=request.getContextPath()%>/views/admin/img/avatars/avatar-3.jpg"
                                                 class="avatar img-fluid rounded-circle"
                                                 alt="Sharon Lessman">
                                        </div>
                                        <div class="col-10 ps-2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="<%=request.getContextPath()%>/views/admin/img/avatars/avatar.jpg"
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                    ...
                                    <div class="modal fade" id="newCatalogModal" tabindex="-1" aria-labelledby="newCatalogLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="<%=request.getContextPath()%>/CatalogServlet?action=Create" method="post">
                                                    <div class="modal-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <span class="input-group-text" id="catatlogtitle">Catalog Title</span>
                                                            <input type="text" name="catatlogtitle" class="form-control" placeholder="Input catalog title"
                                    ...
                                    <div class="modal fade" id="deleteCatalogModal" tabindex="-1" aria-labelledby="deleteCatalogModalLabel"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="<%=request.getContextPath()%>/CatalogServlet?action=delete" method="get">
                                                    <div class="modal-body">
                                    ...
                                    <div class="modal fade" id="updateCatalogModal" tabindex="-1" aria-labelledby="updateCatalogLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="<%=request.getContextPath()%>/CatalogServlet?action=Update" method="post">
                                                    <div class="modal-body">
                                                        <div class="input-group mb-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text" id="catatlogtitleUpdate">Catalog Title</span>
                                                            <input type="text" name="catalogtitle" id="catalogtitle" class="form-control" placeholder="Input catalog title"
                                                                   aria-label="CatalogName" aria-describedby="basic-addon1">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <label class="input-group-text" for="catalogStatus">Catalog Status</label>
                                ...
                                <form class="d-flex" role="search" method="get">
                                    <input class="form-control me-2 fst-italic" type="search" name="search" placeholder="Enter catalog "
                                           aria-label="Search">
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listcatalog}" var="cat">
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" href="#updateCatalogModal" class="update btn btn-warning" data-bs-toggle="modal">update</a>
                                        <a type="button" href="#deleteCatalogModal" class="delete btn btn-danger" data-bs-toggle="modal">delete</a>
...
<script type="text/javascript">
    ...
    $(document).on('click','table .update',function (){
        ...
        $.ajax({
            type:'GET',
            url: '${pageContext.request.contextPath}/CatalogServlet?GetById&&CatalogId=catalogId='+catId,
            success:function (catalogUpdate){
                $('#catalogId').val(catalogUpdate.catalogId);
                $('#catalogName').val(catalogUpdate.catalogName);
                $('#catatlogtitle').val(catalogUpdate.title);
