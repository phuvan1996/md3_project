    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="catalog.jsp">
                    ...
                    <div class="mot">
                        <a class="navbar-brand" href="">
                            <form action="<%=request.getContextPath()%>/ProductServlet" method="post"
                                ...
                                <a class="navbar-brand" href="product.jsp"></a>
                                <table>
                                    <tr>
                                        <td>ProductName</td>
                                        <td><input type="text" name="productId" value="${productUpdate.productId}"
                                                   readonly/></td>
                                    </tr>
                                    <tr>
                                        <td>ProductName</td>
                                        <td><input type="text" name="productName" value="${productUpdate.productName}"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Price</td>
                                    ...
                                    <tr>
                                        <td>Quantity</td>
                                        <td><input type="number" name="quantity" value="${productUpdate.quantity}"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Title</td>
                                    ...
                                    <tr>
                                        <td>ProductImage</td>
                                        <td><input type="file" name="proimage" id="proImages"/>
                                            <img src="<%=request.getContextPath()%>/images/${productUpdate.productImage}"
                                                 alt="${productUpdate.productImage}" width="100" height="100"/>
                                            <input type="hidden" name="oldProImage" value="${productUpdate.productImage}"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Product SubImage</td>
                                        <td><input type="file" name="subImage" id="subImages" multiple/>
                                            <c:forEach items="${productUpdate.listImageUrl}" var="subImg">
                                                <img src="<%=request.getContextPath()%>/images/${subImg}" alt="${subImg}" width="100" height="100"/>
                                                <input type="hidden" value="${subImg}" name="oldSubImg"/>
                                            </c:forEach>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Catalog</td>
                                        <td>
                                            <select id="catalogID" name="catid">
                                                <c:forEach items="${listCreat}" var="cat">
                                                    <option value="${cat.catalogId}"
                                                        ${cat.catalogId==productUpdate.catalogId?'selected':''}>${cat.catalogName}</option>
                                                </c:forEach>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Description</td>
                                        <td><textarea name="prodes" id="prodes">${productUpdate.description}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Product Status</td>
                                        <td><input type="radio" name="productStatus" id="active" value="true"
                                        ${productUpdate.productStatus?'checked':''}/><label
                                                for="active">Còn Hàng</label>
                                            <input type="radio" name="productStatus" id="inactive" value="false"
                                            ${productUpdate.productStatus?'':'checked'}/><label
