                    ...
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="newcatalog.jsp">
                    ...
                    <div class="mot">
                        <form action="<%=request.getContextPath()%>/CatalogServlet" method="post">
                            <table>
                                <tr>
                                    <td>Catalog Id</td>
                                    <td><input type="number" name="catalogId"></td>
                                </tr>
                                <tr>
                                    <td>Catalog Name</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="catalogStatus" id="active" value="true" checked/><label for="active">Hoạt Động</label>
                                        <input type="radio" name="catalogStatus" id="inactive" value="false"/><label for="inactive">Không Hoạt </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
