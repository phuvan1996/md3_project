...
<div class="wrapper">
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="<%=request.getContextPath()%>/views/admin/index.jsp">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<%=request.getContextPath()%>/views/admin/productDetail.jsp">
                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<%=request.getContextPath()%>/views/user/register.jsp">Log out</a>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<%=request.getContextPath()%>/UserServlet?action=unlock&&userId=${user.userId}">
                                    <button name="action" value="unlock" type="button" class="btn btn-success">Unlock</button>
                                    </a>
                                </td>
                                <td>
                                    <a href="<%=request.getContextPath()%>/UserServlet?action=lock&&userId=${user.userId}">
