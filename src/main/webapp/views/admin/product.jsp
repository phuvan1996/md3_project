                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listproduct}" var="pro">
                                <tr>
                                    ...
                                    <td>${pro.catalogId}</td>
                                    <td>
                                        <a class="btn btn-facebook" href="<%=request.getContextPath()%>/ProductServlet?action=update&&productId=${pro.productId}">
                                            Update
                                        </a>
                                        <a class="btn btn-facebook" href="<%=request.getContextPath()%>/ProductServlet?action=delete&&productId=${pro.productId}">
                                            Delete
                                        </a>
                                        <a class="btn btn-facebook"href="<%=request.getContextPath()%>/ProductServlet?action=GetById&&productId=${pro.productId}">
                                            Detail
                                        </a>
                                    </td>
                                </tr>
